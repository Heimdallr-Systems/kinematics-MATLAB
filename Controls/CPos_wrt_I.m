...
r1fromB_FR = [153.4;-53.31;50]./1000;
r2from1_FR = [0;-65.25;26.25]./1000;
r3from2_FR = [0;-224.68;0]./1000;
rcfrom3_FR = [0;-279;0]./1000;

% Relative FL Leg Positions
r1fromB_FL = [153.4;53.31;50]./1000;
r2from1_FL = [0;65.25;26.25]./1000;
r3from2_FL = [0;224.68;0]./1000;
rcfrom3_FL = [0;279;0]./1000;

% Relative BR Leg Positions
r1fromB_BR = [-153.4;-53.31;50]./1000;
r2from1_BR = [0;-65.25;26.25]./1000;
r3from2_BR = [0;-224.68;0]./1000;
rcfrom3_BR = [0;-279;0]./1000;

% Relative BL Leg Positions
r1fromB_BL = [-153.4;53.31;50]./1000;
r2from1_BL = [0;65.25;26.25]./1000;
r3from2_BL = [0;224.68;0]./1000;
rcfrom3_BL = [0;279;0]./1000;
