function [Theta1, Theta2, Theta2_2, Theta3, Theta3_2] = Body_Pose_Controller(r_II_c, T_I_B, r_II_B_d, legs_on_gnd)
...
while loop_toggle == 0
    ...
    if legs_on_gnd(1) == 1
        ...
        try
            ...
            loop_toggle = 1;
            r_II_B_d = r_II_B_d - [sign(r_II_B_d(1))*0.01;sign(r_II_B_d(1))*0.01;0];
        end
