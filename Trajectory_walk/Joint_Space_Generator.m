...
[Theta1_d,Theta2_d,Theta3_d] = Joint_Space_Solver(Theta1, Theta2, Theta3, Euler_0, r_II_B_0, r_II_B_d(:,ii), legs_on_gnd);
    ...
    if(legs_valid(1)==0) % FR
        ...
        r_II_c_FR=step_planner_intelligent(r_II_B_d(:,ii-1),r_II_B_d(:,ii),r_II_c,1,dist,[0 0;0 0],10);
    ...
    if(legs_valid(2)==0) % FL
       % Theta1_d(2)=0;
        ...
        r_II_c_FL=step_planner_intelligent(r_II_B_d(:,ii-1),r_II_B_d(:,ii),r_II_c,2,dist,[0 0;0 0],10);
    ...
    if(legs_valid(3)==0) % BR
        ...
        %Theta2_d(3)=0;
            ...
            r_II_c_BL=step_planner_intelligent(r_II_B_d(:,ii-1),r_II_B_d(:,ii),r_II_c,3,dist,[0 0;0 0],10);
    ...
    if(legs_valid(4)==0) % BL
        ...
        r_II_c_BL=step_planner_intelligent(r_II_B_d(:,ii-1),r_II_B_d(:,ii),r_II_c,4,dist,[0 0;0 0],10);
